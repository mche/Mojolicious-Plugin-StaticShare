$( document ).ready(function() {
  ...
  **********************************************/
  function  f_ToggleDirCheckbox(chb, rename, href) {
    ...
    if (action == 'dir') {// new folder
      //~ $('a', tr).toggleClass('text-lighten-5 text-darken-4');
      //~ $('svg', tr).toggleClass('fill-lighten-5 fill-darken-4');
    }
  ...
  **************/
  ...
  $('.dirs-col .btn-panel a.renames').on('click', function(ev){
    $('table.dirs input[type="checkbox"]:checked').each(function(){ f_ToggleDirCheckbox($(this)); });
